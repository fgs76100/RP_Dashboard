...
file_to_read = 'ApolloPro_RLE0787_SoC_testchip_RegisterFile.xls'


class RegisterProfileReader:

    def __init__(self, xls_file, blocks=None):
        self.xls = xls_file
        self.blocks = blocks
        self.mem_blocks = {}
        ...
        for each_block in self.blocks:
            ...
            with open_workbook(self.xls) as xls:
                try:
                    ...
                    print('Warning: The sheet of "file_{0}" Not found.'.format(each_block))
                    continue
                else:
                    nrows = sheet.nrows
                    for i in range(nrows):
                        ...
                        if cells[0].lower() == col_to_read[0].lower() and cells[1].lower() == col_to_read[1].lower():
                            ...
                            continue
            if not read_en:
                print('Warning!! {} column headers failed to locate.'.format(each_block))
